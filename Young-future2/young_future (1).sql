...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2023 a las 03:36:38
...
(7, 'Lulu2684', 'Luisa', 'Isaza', 'luisamariaia42@gmail.com', '1034987040', 1, '1', '1'),
(13, 'LUMA', 'Marta Laura', 'Agudelo Marulanda', 'agudelomarta67@gmail.com', 'Luma2608.', 2, '2', '1');
...
ALTER TABLE `usuario`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `intereses` (`intereses`);
...
--
ALTER TABLE `carreras`
  ADD CONSTRAINT `carreras_ibfk_1` FOREIGN KEY (`intereses`) REFERENCES `intereses` (`id`),
  ADD CONSTRAINT `carreras_ibfk_2` FOREIGN KEY (`intereses`) REFERENCES `intereses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`intereses`) REFERENCES `intereses` (`id`);
COMMIT;
