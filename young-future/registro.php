            ...
            <div class="row">
                ...
                <h1 id="title-1">Registrarse</h1>
                    ...
                    <form method="post" action="registrar.php" id="formulario1">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" readonly class="form-control-plaintext" id="floatingPlaintextInput" placeholder="apellido" value="Apellido">
                            <div class="input-group flex-nowrap mb-3" id="input">
                        ...
                        <div class="form-floating mb-3" id="input">
                            <select name="interes" class="form-control-plaintext" id="floatingPlaintextInput" aria-label="Lista de intereses">
                        ...
                        <div>
                            <input type="submit" name="registrar" value="Registar" id="btn"><br><br>
                            <a href="inicioseccion.php">¿Ya tienes una cuenta?, inicia sesión aquí</a>
                        </div>
                    </form> 
